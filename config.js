...
(() => {
  ...
  const modules = [
    ...
    { name: "family-backup-media", version: "20260913-records-v1", style: false },
    { name: "family-journal", version: "20260915-growth-performance-v1" },
    { name: "settings-backup", version: "20260913-records-v1", style: false },
    { name: "settings-family-management", version: "20260913-records-v1" },
    { name: "settings-data-export", version: "20260913-records-v1", style: false },
    ...
    { name: "family-onboarding", version: "20260830-auth-recovery-v2" },
    { name: "family-search", version: "20260805-family-search-v1" },
    { name: "adaptive-feeding", version: "20260915-growth-performance-v1" },
    { name: "feeding-quick-unified", version: "20260727-direct-stepper-v1" },
    { name: "care-entry-edit-fix", version: "20260915-growth-performance-v1" },
    ...
    { name: "weekly-care-extra-feeding", version: "20260806-health-pattern-v1", script: false },
    ...
    { name: "typography-system", version: "20260824-event-change-push-v1", script: false },
    ...
    { name: "growth-inline-chart", version: "20260915-growth-performance-v1" },
    ...
    { name: "invite-link", version: "20260912-security-v1" },
    ...
    { name: "night-care-pattern-polish", version: "20260806-health-pattern-v1", script: false },
    ...
    { name: "travel", version: "20260924-custom-destination-v1" },
  ];
