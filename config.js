...
(() => {
  ...
  const modules = [
    ...
    { name: "growth-default-today", version: "20260719-v1", style: false },
    ...
    { name: "notification-center", version: "20260720-v1" },
    ...
    { name: "calendar-event-range", version: "20260718-readable-range-v1", script: false },
