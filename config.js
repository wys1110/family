...
(() => {
  ...
  const modules = [
    ...
    { name: "notification-center", version: "20260720-header-tabs-v2" },
    ...
    { name: "growth-chart-polish", version: "20260718-premium-v1" },
    ...
    { name: "calendar-event-range", version: "20260720-tablet-lanes-v3", script: false },
