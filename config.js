...
(() => {
  ...
  const modules = [
    ...
    { name: "growth-delete-sync", version: "20260824-event-change-push-v1" },
    ...
    { name: "daily-briefing", version: "20260824-event-change-push-v1" },
    { name: "event-change-push", version: "20260824-event-change-push-v1", style: false },
    ...
    { name: "notification-center", version: "20260824-event-change-push-v1" },
