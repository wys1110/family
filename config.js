...
(() => {
  ...
  const modules = [
    ...
    { name: "refresh-button", version: "20260722-bottom-center-v4" },
    ...
    { name: "feeding-quick-unified", version: "20260722-instant-direct-v2" },
    ...
    { name: "growth-inline-chart", version: "20260722-history-v2" },
