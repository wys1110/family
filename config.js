...
(() => {
  ...
  const modules = [
    { name: "family-auth", version: "20260830-auth-recovery-v1", style: false },
    ...
    { name: "settings-family-management", version: "20260830-auth-recovery-v2" },
    { name: "settings-data-export", version: "20260830-auth-recovery-v2", style: false },
    ...
    { name: "family-todo", version: "20260830-auth-recovery-v2" },
    ...
    { name: "family-handoff", version: "20260810-v1" },
    ...
    { name: "invite-link", version: "20260830-auth-recovery-v2" },
