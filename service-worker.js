...
self.addEventListener("fetch", (event) => {
  ...
  const forceNetwork =
    ...
    url.pathname.endsWith("/theme-v2.css") ||
    url.pathname.endsWith("/theme-bootstrap.js") ||
    url.pathname.endsWith("/theme-critical.css") ||
    ...
    url.pathname.endsWith("/admin-ops.js") ||
    url.pathname.endsWith("/settings-backup.js") ||
    url.pathname.endsWith("/settings-family-management.js") ||
